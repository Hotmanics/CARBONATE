  ...
  return (
    <>
      <div className="flex flex-col items-center flex-grow pt-10 space-y-4">
        <div className="flex flex-col bg-base-100 px-5 text-center lg:w-[720px] rounded-lg shadow-md shadow-secondary">
        ...
        <div className="flex flex-col items-center w-full bg-base-100 px-5">
